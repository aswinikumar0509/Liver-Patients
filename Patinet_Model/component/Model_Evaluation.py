...
from Patinet_Model.entity import config_entity,artifact_entity
from Patinet_Model.exception import PatientsException
from Patinet_Model.logger import logging
from Patinet_Model.utils import load_object
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            if latest_dir_path==None:
                model_eval_artifact = artifact_entity.ModelEvaluationArtifact(is_model_accept=True,improved_accuracy=None)
