...
class DataIngestionConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        try:
            #self.database_name = "INDIAN_LIVER_PATIENT"
...
class DataValidationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.base_file_path = os.path.join('indian_liver_patient.csv')

class DataTransformationConfig:

    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.data_transformation_dir = os.path.join(training_pipeline_config.artifact_dir,"data_transformation")
        self.tranformation_object_path = os.path.join(self.data_transformation_dir,"transformer",TRANSFORMER_OBJECT_FILE_NAME)
